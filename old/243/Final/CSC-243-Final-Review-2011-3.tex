...
\end{answer}
    ...
    \item Now implement the MeanWorker class, which should choose a size and
...
maps from {\tt ints} to Strings.

\begin{figure}[h]
\caption{A partially drawn $\textrm{B}^+$Tree of strings, keyed on {\tt int}s}
\label{b-tree}
\center
...
\lstinputlisting{code/ufo/Cow.java}
\lstinputlisting{code/ufo/Human.java}
\lstinputlisting{code/ufo/Professor.java}
\lstinputlisting{code/ufo/RedNeck.java}
