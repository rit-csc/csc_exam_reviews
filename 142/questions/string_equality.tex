...
By default, Object's equal() compares memory addresses, but it can be extended by subclasses to check the objects' attributes.  In Java, it is not possible to override how == works.
