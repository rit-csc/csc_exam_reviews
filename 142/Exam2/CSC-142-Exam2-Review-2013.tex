...
\item Suppose we are talking about the depth-first search (DFS) algorithm.  When given a choice, nodes are added to the data structures in alphabetical order.
\begin{enumerate}
