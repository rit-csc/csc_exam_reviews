...
\item Discuss the differences between an ArrayList and a LinkedList. Which would be better in each of the following situations?
...
5) Collections - easy sorting
6) Swing - layouts
7) Collection - lists
8) Swing - full GUI
9) Exception - types
10) Anonymous classes, Swing - action listener
