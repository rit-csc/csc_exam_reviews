...
\item What is the difference between a constant and a normal variable? Give an example of a constant declaration.
    ...
    public static {\bf final} int NUM_PEOPLE_WHO_LIKE_JAVA = 0;
    \end{answer}
...
\item\label{qsort-worst-case} What kind of data causes Quicksort's worst-case time complexity? You may assume that we always pick the first element as the pivot.
