...
\begin{answer}
A class defines methods and properties---it can be viewed as a template. An object is  an instance of a class. Think of classes as molds and objects as individual things created by those molds.
\end{answer}
...
{\tt public static final int NUM\_PEOPLE\_WHO\_LIKE\_JAVA = 0;}
\end{answer}
...
\begin{answer}
	\begin{matchtabular}
	Megresort & Splits its input into two other lists... \\
	Quicksort & Splits its input into two (or three)...  \\
	Heapsort  & Elements are taken out...                \\
	\end{matchtabular}
\end{answer}
