	...
	\begin{answer}
		Heapify: \\
			...
			\begin{tikzpicture}[scale=1]
				...
				\node [draw, ellipse] at (1, -1) (5) {3};
				\node [draw, ellipse] at (-2, -2) (3) {5};
			...
			\begin{tikzpicture}[scale=1]
				...
				\node [draw, ellipse] at (2, -1) (5) {3};
				\node [draw, ellipse] at (-3, -2) (3) {5};
		...
		Sort: \\
			...
			\begin{tikzpicture}[scale=1]
				...
				\node [draw, ellipse] at (-2,-1) (2) {5};
				\node [draw, ellipse] at (2, -1) (5) {3};
				\node [draw, ellipse] at (-3, -2) (3) {7};
				\node [draw, ellipse] at (-1, -2) (31) {9};
				...
				\path [draw] (2) -- (31);
			\end{tikzpicture} &
			[\underline{3}, \underline{5}, \underline{3}, \underline{7}, \underline{9}, 2, 1] \\
			...
			\begin{tikzpicture}[scale=1]
				...
				\path [draw] (1) -- (5);
			\end{tikzpicture} &
			[\underline{3}, \underline{5}, \underline{9}, \underline{7}, 3, 2, 1] \\
...
TODO: Eric had a good example during the last review session for the question
about polymorphism, which is currently pretty dry. It was about animals trampling
people, and maybe we should rework the question to include it.
