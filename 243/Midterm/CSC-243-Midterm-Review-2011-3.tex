...
\end{lstlisting}
    ...
    25  & FIXME Does autoboxing make this legal?\\
    30  & Truck implements vehicle, but does not have getSpeed()\\
    46  & {\tt prius} was declared as a {\tt Vehicle}, so we can't call\\
    ~   & methods that aren't declared in {\tt Vehicle}.\\
    48  & FIXME I don't think it's legal to pass a double to an int.
    \end{tabular}
    \end{answer}
