...
\item What is the difference between a constructor and a normal method?
    ...
    \begin{answer}
A Constructor is a special method which creates an instance of a class. It requres the use of the new keyword (or this() or super()) and can not be directly invoked by a method call. Constuctors have no return type and have the same name as the class. 
    \end{answer}
...
\item What is the difference between an abstract class and an interface? Why
      ...
      \begin{answer}
Abstract classes allow for default method definition, any class which extends this abstract class has access to these definitions. An interface is a list of methods and proprties that any class which implement this interface must define.
